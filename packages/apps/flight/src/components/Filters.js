...
import { MdFlight, MdHighlightOff } from 'react-icons/md';
...
export default (props) => {
  ...
  let ReturnIcon = [
    <MdFlight key={1} />,
    <MdFlight key={2} className="reverse" />
  ];
  return (
    <div className="filters">
      <Tabs>
        <Tab active={!props.roundTrip} label="One Way" icon={<MdFlight />} onClick={() => props.onChange('roundTrip', false)} />
      ...
      <form>
        ...
        <div className="price">
          ...
          <MdHighlightOff style={{ margin: 3 }} onClick={e => {
